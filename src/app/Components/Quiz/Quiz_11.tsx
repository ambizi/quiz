...
export default function Quiz_11 () {
          ...
          <article className={styles.art2}>
            <div className={styles.box3}>
              <div className={styles.circles}>
                ...
                <Image src={imagens.Blue_Circle} alt="Circle" width={14} height={14} className={styles.Circle_Quiz_11}/>
                <Image src={imagens.Gray_Circle} alt="Circle" width={14} height={14} className={styles.Circle_Quiz_12}/>
              </div>
              <h2 className={styles.text4}>Você já fez algum tipo de tratamento com Psicólogos / Psiquiatras ou afins?</h2>
              <div className={styles.quiz_box}>
                <button className={styles.quiz11_yes} onClick={a =>registerQuiz(true)}>Sim</button>
                <button className={styles.quiz11_no}  onClick={a =>registerQuiz(false)} >Não</button>
              </div>
            </div>
          </article>
        </>
