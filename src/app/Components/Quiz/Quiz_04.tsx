          ...
          <article className={styles.art2}>
            <div className={styles.box3}>
              <div className={styles.circles}>
                ...
                <Image src={imagens.Blue_Circle} alt="Circle" width={14} height={14} className={styles.Circle_Quiz_4}/>
              ...
              <h2 className={styles.text4}>Tem experimentado mudanças significativas de apetite ou perda de peso inexplicada?</h2>
              <div className={styles.quiz_box}>
                <button className={styles.quiz04_yes} onClick={a =>registerQuiz(true)}>Sim</button>
                <button className={styles.quiz04_no}  onClick={a =>registerQuiz(false)} >Não</button>
              </div>
            </div>
          </article>
        </>
