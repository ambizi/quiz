          ...
          <article className='art2'>
            <div className='box3'>
              ...
              <div className='quiz_box'>
                <button className='quiz01_button1'>-18</button>
                <button className='quiz01_button2'>18 a 25</button>
                <button className='quiz01_button3'>26 a 35</button>
                <button className='quiz01_button4'>36 a 45</button>
                <button className='quiz01_button5'>46 a 60</button>
                <button className='quiz01_button6'>61 a 70</button>
                <button className='quiz01_button7'>+70</button>
              </div>
            </div>
          </article>
        </>
