          ...
          <article className={styles.art2}>
            <div className={styles.box3}>
              <div className={styles.circles}>
                ...
                <Image src={imagens.Blue_Circle} alt="Circle" width={14} height={14} className={styles.Circle_Quiz_3}/>
              ...
              <h2 className={styles.text4}>Você tem dificuldade em dormir ou tem problemas de sono frequentes?</h2>
              <div className={styles.quiz_box}>
                <button className={styles.quiz03_yes} onClick={a =>registerQuiz(true)}>Sim</button>
                <button className={styles.quiz03_no}  onClick={a =>registerQuiz(false)} >Não</button>
              </div>
            </div>
          </article>
        </>
