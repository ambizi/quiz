          ...
          <article className='art1'>
            <div className='box2'>
              <div className='art1_box_text'>
                ...
                <button className='text3'>Partcipe do teste
                  <Image src={imagens.Arrow} alt="Arrow" width={20} height={15} className='arrow'/></button>
              </div>
              <div className='hero'>
                <Image src={imagens.Hero} alt="Hero" width={608} height={482} className='hero_p'/>
              </div>
            </div>
          </article>
        </>
